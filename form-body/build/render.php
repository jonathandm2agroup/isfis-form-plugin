					...
					if($value !== ""){
						...
						switch ($prefijo) {
							...
							case 'email-':
								...
								$contentData .= '<!-- wp:create-block/isfis-email-input {"textName":"'.$dataForm.'","valueInput":"'.$value.'","placeholder":"text-input"} /-->';
								break;
							case 'textArea-':
								// Acción para prefijo 'textArea-'
								$dataForm = str_replace('textArea-', '', $label);
								$contentData .= '<!-- wp:create-block/isfis-textarea {"textName":"'.$dataForm.'","valueInput":"'.$value.'","placeholder":"text-input"} /-->';
								break;
							default:
								break;
						}
